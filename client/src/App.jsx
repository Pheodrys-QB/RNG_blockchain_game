...
function App() {
  const CONTRACT_ADDRESS =  "0x27D5E0fB70e2e80d382f6369926A77d1D3E27423"; //import.meta.env.VITE_CONTRACT_ADDRESS ;
  const CONTRACT_ABI = contract_json.abi;
  const ETHERSCAN_API_KEY = "UC5BR5S9MUGFZGRK2IPTK9C58UU1DMAIGY"; //import.meta.env.VITE_ETHERSCAN_PRIVATE_KEY;
